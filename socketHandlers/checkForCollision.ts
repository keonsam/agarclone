      ...
      if (
        ...
        if (distance < pData.radius + pR) {
          ...
          if (pData.radius > pR) {
            ...
            players.splice(i, 1, {} as Player); //remove player from server players array
            playersForUsers.splice(i, 1, {} as PlayerData); //remove player from players array used by clients
